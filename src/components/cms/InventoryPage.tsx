...
const initialInbound: InboundRecord[] = [
  { id: 'INB-001', date: '۱۴۰۳/۰۹/۱۵', itemName: 'لپ‌تاپ ایسوس زنف‌بوک', quantity: 10, supplier: 'شرکت آسوس ایران', reference: 'PO-2024-1101', status: 'received' },
  { id: 'INB-002', date: '۱۴۰۳/۰۹/۱۲', itemName: 'گوشی سامسونگ گلکسی S24', quantity: 20, supplier: 'سامسونگ الکترونیکس', reference: 'PO-2024-1098', status: 'received' },
  { id: 'INB-003', date: '۱۴۰۳/۰۹/۱۰', itemName: 'پیراهن مردانه کلاسیک', quantity: 50, supplier: 'پوشاک پارس', reference: 'PO-2024-1092', status: 'received' },
  { id: 'INB-004', date: '۱۴۰۳/۰۹/۰۸', itemName: 'عسل طبیعی کوهستان', quantity: 100, supplier: 'عسل طبیعی زند', reference: 'PO-2024-1085', status: 'received' },
  { id: 'INB-005', date: '۱۴۰۳/۰۹/۰۵', itemName: 'دریل بوش چکشی', quantity: 5, supplier: 'ابزار برقی نوین', reference: 'PO-2024-1078', status: 'pending' },
  { id: 'INB-006', date: '۱۴۰۳/۰۹/۰۳', itemName: 'ست آشپزخانه ۱۲ پارچه', quantity: 15, supplier: 'آشپزخانه مطلق', reference: 'PO-2024-1070', status: 'pending' },
  { id: 'INB-007', date: '۱۴۰۳/۰۹/۰۱', itemName: 'کفش ورزشی نایکی', quantity: 30, supplier: 'ورزشکاران', reference: 'PO-2024-1065', status: 'received' },
  { id: 'INB-008', date: '۱۴۰۳/۰۸/۲۸', itemName: 'دستگاه قهوه‌ساز دلونگی', quantity: 8, supplier: 'قهوه‌تک', reference: 'PO-2024-1058', status: 'received' },
  { id: 'INB-009', date: '۱۴۰۳/۰۸/۲۵', itemName: 'زعفران نگین سرگل', quantity: 25, supplier: 'زعفران قائنات', reference: 'PO-2024-1050', status: 'pending' },
  { id: 'INB-010', date: '۱۴۰۳/۰۸/۲۲', itemName: 'کاغذ A4 کپی', quantity: 200, supplier: 'کاغذ ایرانیان', reference: 'PO-2024-1042', status: 'received' },
]

const initialOutbound: OutboundRecord[] = [
  { id: 'OUT-001', date: '۱۴۰۳/۰۹/۱۴', itemName: 'لپ‌تاپ ایسوس زنف‌بوک', quantity: 3, destination: 'فروشگاه آنلاین دیجی‌کالا', reference: 'SO-2024-2201', status: 'shipped' },
  { id: 'OUT-002', date: '۱۴۰۳/۰۹/۱۳', itemName: 'گوشی سامسونگ گلکسی S24', quantity: 5, destination: 'مشتری: احمد رضایی', reference: 'SO-2024-2198', status: 'shipped' },
  { id: 'OUT-003', date: '۱۴۰۳/۰۹/۱۱', itemName: 'پیراهن مردانه کلاسیک', quantity: 15, destination: 'فروشگاه مرکزی تهران', reference: 'SO-2024-2190', status: 'shipped' },
  { id: 'OUT-004', date: '۱۴۰۳/۰۹/۰۹', itemName: 'عسل طبیعی کوهستان', quantity: 30, destination: 'سوپرمارکت رفاه', reference: 'SO-2024-2185', status: 'shipped' },
  { id: 'OUT-005', date: '۱۴۰۳/۰۹/۰۷', itemName: 'کفش ورزشی نایکی', quantity: 10, destination: 'باشگاه ورزشی آریا', reference: 'SO-2024-2178', status: 'pending' },
  { id: 'OUT-006', date: '۱۴۰۳/۰۹/۰۶', itemName: 'دریل بوش چکشی', quantity: 2, destination: 'ساخت‌وساز پایدار', reference: 'SO-2024-2175', status: 'shipped' },
  { id: 'OUT-007', date: '۱۴۰۳/۰۹/۰۴', itemName: 'دستگاه قهوه‌ساز دلونگی', quantity: 4, destination: 'کافه کتاب مروارید', reference: 'SO-2024-2168', status: 'pending' },
  { id: 'OUT-008', date: '۱۴۰۳/۰۹/۰۲', itemName: 'ست آشپزخانه ۱۲ پارچه', quantity: 8, destination: 'فروشگاه آنلاین باسلام', reference: 'SO-2024-2160', status: 'shipped' },
  { id: 'OUT-009', date: '۱۴۰۳/۰۸/۳۰', itemName: 'مانتو زنانه بهاره', quantity: 12, destination: 'بوتیک نگین', reference: 'SO-2024-2155', status: 'shipped' },
  { id: 'OUT-010', date: '۱۴۰۳/۰۸/۲۷', itemName: 'کاغذ A4 کپی', quantity: 50, destination: 'اداره کل آموزش و پرورش', reference: 'SO-2024-2148', status: 'pending' },
]
...
export default function InventoryPage() {
  ...
  const [inboundRecords] = useState<InboundRecord[]>(initialInbound)
  const [outboundRecords] = useState<OutboundRecord[]>(initialOutbound)
  ...
  const [newItem, setNewItem] = useState({ name: '', sku: '', category: 'electronics', stock: 0, minStock: 0, unitPrice: 0 })
  ...
  const categoryDistribution = useMemo(() => {
    ...
    items.forEach(item => {
      if (!map[item.category]) {
        map[item.category] = { count: 0, value: 0, stock: 0 }
      }
      map[item.category].count++
      map[item.category].value += item.stock * item.unitPrice
  ...
  const filteredOutbound = outboundRecords.filter(r => {
    const matchSearch = r.itemName.includes(outboundSearch) || r.destination.includes(outboundSearch) || r.reference.includes(outboundSearch)
  ...
  const handleAddItem = () => {
    ...
    setNewItem({ name: '', sku: '', category: 'electronics', stock: 0, minStock: 0, unitPrice: 0 })
                    ...
                    <div key={cat.category} className="animate-in" style={{ animationDelay: `${idx * 60}ms`, animationFillMode: 'both' }}>
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm font-medium ${colors.text}`}>{categoryLabels[cat.category] ?? cat.category}</span>
                    ...
                    {filteredInbound.length === 0 ? (
                      ...
                      filteredInbound.map((record, idx) => (
                        <TableRow
                          ...
                          style={{ animationDelay: `${idx * 30}ms`, animationFillMode: 'both' }}
                        >
                          <TableCell className="text-sm tabular-nums">{record.date}</TableCell>
                          <TableCell>
                            <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="glass-card hover-lift shadow-sm animate-in card-elevated" style={{ animationDelay: '0ms', animationFillMode: 'both' }}>
              <CardContent className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-muted-foreground">{labels.reportsTab.totalValue}</p>
                    ...
                    <div key={cat.category} className="animate-in" style={{ animationDelay: `${idx * 80}ms`, animationFillMode: 'both' }}>
                      <div className="flex items-center justify-between mb-1.5">
                        <div className="flex items-center gap-3">
                          ...
                          <span className={`text-sm font-semibold ${colors.text}`}>{categoryLabels[cat.category] ?? cat.category}</span>
                        </div>
                        <div className="flex items-center gap-3">
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="p-3 rounded-lg bg-muted/30 border text-center">
                    ...
                    {categoryDistribution.length > 0 && (
                      <>
                        <p className="text-sm font-semibold">{categoryLabels[categoryDistribution[0].category]}</p>
                  ...
                  <div className="p-3 rounded-lg bg-muted/30 border text-center">
                    ...
                    {categoryDistribution.length > 0 && (
                      <>
                        <p className="text-sm font-semibold">{categoryLabels[categoryDistribution[categoryDistribution.length - 1].category]}</p>
        ...
        <DialogContent className="max-w-md glass-card shadow-xl">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!newItem.name.trim() || !newItem.sku.trim()}
            >
