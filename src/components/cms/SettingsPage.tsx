...
function SettingsSection({ icon, title, children, color }: { icon: React.ReactNode; title: string; children: React.ReactNode; color: string }) {
  return (
...
export default function SettingsPage() {
  ...
  const handleSave = (group: string) => {
    ...
    const items = keys.map(key => ({
      key, value: String(form[key]), group: group as 'general' | 'seo' | 'ai' | 'content' | 'security',
    }))
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 page-enter">
      ...
      <Tabs defaultValue="general" className="space-y-4">
        <TabsList className="bg-teal-100 dark:bg-teal-900/30 h-11 shadow-sm">
          ...
          <TabsTrigger value="security" className="gap-2 data-[state=active]:bg-teal-600 data-[state=active]:text-white transition-all duration-200">
        ...
        <TabsContent value="general" className="animate-in">
          <SettingsSection icon={<Globe className="h-5 w-5" />} title="تنظیمات عمومی" color="text-teal-700 dark:text-teal-300">
        ...
        <TabsContent value="seo" className="animate-in">
          <SettingsSection icon={<Search className="h-5 w-5" />} title="تنظیمات سئو" color="text-teal-700 dark:text-teal-300">
            <div className="space-y-2">
        ...
        <TabsContent value="ai" className="animate-in">
          <SettingsSection icon={<Bot className="h-5 w-5" />} title="تنظیمات هوش مصنوعی" color="text-teal-700 dark:text-teal-300">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
        ...
        <TabsContent value="content" className="animate-in">
          <SettingsSection icon={<FileText className="h-5 w-5" />} title="تنظیمات محتوا" color="text-teal-700 dark:text-teal-300">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
        ...
        <TabsContent value="security" className="animate-in">
          <SettingsSection icon={<Shield className="h-5 w-5" />} title="تنظیمات امنیتی" color="text-teal-700 dark:text-teal-300">
            <div className="flex items-center justify-between p-4 rounded-xl bg-background/50 border border-teal-100/50 dark:border-teal-800/20 transition-all duration-200 hover:bg-teal-500/5">
              <div>
