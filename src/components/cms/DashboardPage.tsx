        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="h-7 w-7 rounded-lg bg-emerald-500/10 flex items-center justify-center"><Database className="h-4 w-4 text-emerald-500 drop-shadow-sm" /></div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="h-7 w-7 rounded-lg bg-emerald-500/10 flex items-center justify-center"><Wifi className="h-4 w-4 text-emerald-500 drop-shadow-sm" /></div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="h-7 w-7 rounded-lg bg-violet-500/10 flex items-center justify-center"><HardDrive className="h-4 w-4 text-violet-500 drop-shadow-sm" /></div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="h-7 w-7 rounded-lg bg-emerald-500/10 flex items-center justify-center"><Server className="h-4 w-4 text-emerald-500 drop-shadow-sm" /></div>
          ...
          {ANALYTICS_METRICS.map((metric, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                <div className={`h-9 w-9 rounded-lg ${metric.iconBg} flex items-center justify-center ${metric.iconColor} drop-shadow-sm`}>
                  {metric.icon}
                </div>
                <Badge className={`text-[10px] gap-0.5 border-0 px-1.5 py-0 ${
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 page-enter">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4">
        ...
        <StatCard icon={<FolderKanban className="h-5 w-5" />} label={labels.totalProjects} value={statsData?.totalProjects ?? '—'} numericValue={statsData?.totalProjects} color="from-indigo-500 to-indigo-700" delay={150} sparklineData={[3, 3, 2, 4, 3, 3, 4]} sparklineColor="rgba(255,255,255,0.8)" trend="flat" />
